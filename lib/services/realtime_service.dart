...
class RealtimeService {
  ...
  Future<void> subscribeToPostLikes(String postId, Function(int newCount) onUpdate) async {
  ...
  Future<void> subscribeToPostComments(String postId, Function(Map<String, dynamic> comment) onNewComment) async {
