...
class DogShareResult {
  ...
  DogShareResult(
      {required this.shareCode, required this.shareUrl, required this.qrData});
}
...
class SharedDog {
  ...
  factory SharedDog.fromJson(Map<String, dynamic> json) {
    return SharedDog(
      ...
      sharedAt:
          json['shared_at'] != null ? DateTime.parse(json['shared_at']) : null,
    );
  }
}
...
class DogSharingService {
  ...
  static Future<DogShareResult> createShare({
    ...
    final response =
        await SupabaseConfig.client.rpc('create_dog_share', params: {
      'p_dog_id': dogId,
      'p_owner_id': ownerId,
  ...
  static Future<DogShareAcceptResult> acceptShare({
    ...
    final response =
        await SupabaseConfig.client.rpc('accept_dog_share', params: {
