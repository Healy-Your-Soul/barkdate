...
class _AdminScreenState extends State<AdminScreen> {
  ...
  void _showQrCodeDialog(FeaturedPark park) {
    final qrUrl =
        QrCheckInService.getWebFallbackUrl(park.id, park.qrCheckInCode!);
            ...
            Container(
              ...
              child: QrImageView(
                ...
                embeddedImage: const AssetImage(
                    'assets/images/logo.png'), // Optional: Add app logo if available
        ...
        actions: [
          TextButton.icon(
            onPressed: () async {
              ...
              final filename =
                  'BarkDate_QR_${sanitizedName}_${park.qrCheckInCode}.png';
          ...
          TextButton.icon(
            onPressed: () async {
              ...
              Clipboard.setData(
                  ClipboardData(text: 'Filename: $filename\nURL: $qrUrl'));
              Navigator.pop(context);
                          ...
                          children: [
                            Expanded(
                              child: ElevatedButton(
                                onPressed:
                                    _isLoading ? null : _saveFeaturedPark,
                                child: _isLoading
                                    ? const SizedBox(
                                        height: 20,
                                        width: 20,
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Card(
                                child: ExpansionTile(
                                  ...
                                  subtitle: Text(
                                      park.address ?? 'No address provided'),
                                  leading: Icon(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              if (park.qrCheckInCode !=
                                                  null) ...[
                                                IconButton(
                                                  icon: const Icon(Icons.copy),
                                                  tooltip: 'Copy QR URL',
                                                  onPressed: () {
                                                    final url = QrCheckInService
                                                        .getWebFallbackUrl(
                                                      park.id,
                                                      park.qrCheckInCode!,
                                                    );
