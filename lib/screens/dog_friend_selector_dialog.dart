...
class DogFriendSelectorDialog extends StatefulWidget {
  ...
  @override
  State<DogFriendSelectorDialog> createState() =>
      _DogFriendSelectorDialogState();
}
                    ...
                    : Scrollbar(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isSelected =
                                _selectedIds.contains(option.dogId);
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            if (option.dogBreed != null &&
                                                option
                                                    .dogBreed!.isNotEmpty) ...[
                                              const SizedBox(width: 6),
                                              const Icon(Icons.circle, size: 4),
                                              const SizedBox(width: 6),
                                              Text(option.dogBreed!,
                                                  style: theme
                                                      .textTheme.bodySmall),
                                            ],
                                          ],
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FilledButton.icon(
                      onPressed:
                          widget.options.isEmpty ? null : _confirmSelection,
