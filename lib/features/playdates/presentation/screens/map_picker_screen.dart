    ...
    try {
      ...
      if (mounted) {
        ...
        final filteredPlaces = switch (_selectedCategory) {
          ...
          _ => places.places
              .where((p) =>
                  p.category.name.toLowerCase() == _selectedCategory ||
                  p.category.name.toLowerCase().contains(_selectedCategory))
              .toList(),
        };
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(
                        height: 12), // Gap between search and filters
            ...
            Positioned(
              ...
              bottom: _selectedPlace != null
                  ? 320
                  : 32, // Adjust based on sheet height
