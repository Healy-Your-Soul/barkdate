...
class _DogSearchSheetState extends State<DogSearchSheet> with SingleTickerProviderStateMixin {
  ...
  Dog _mapToDog(Map<String, dynamic> json) {
    return Dog(
      ...
      size: 'medium', // Default
      gender: 'unknown',
      bio: json['owner_name'] != null ? 'Owner: ${json['owner_name']}' : 'No bio', // Store owner name in bio for display
