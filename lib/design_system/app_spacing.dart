...
class AppSpacing {
  ...
  static const EdgeInsets screenMarginHorizontal = EdgeInsets.symmetric(horizontal: lg);
  static const EdgeInsets screenMarginVertical = EdgeInsets.symmetric(vertical: lg);
