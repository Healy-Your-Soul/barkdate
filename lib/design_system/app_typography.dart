...
class AppTypography {
  // Configure GoogleFonts to allow fallback on iOS
  ...
  static TextStyle display1({Color? color, FontWeight? fontWeight}) => _safeJotiOne(
    fontSize: 40,
    fontWeight: fontWeight ?? FontWeight.w400,
    letterSpacing: 0,
    height: 1.2,
  ...
  static TextStyle display2({Color? color, FontWeight? fontWeight}) => _safeJotiOne(
    fontSize: 32,
    fontWeight: fontWeight ?? FontWeight.w400,
    letterSpacing: 0,
    height: 1.2,
  ...
  static TextStyle bodyLarge({Color? color, FontWeight? fontWeight}) => _safePoppins(
    fontSize: 16,
    fontWeight: fontWeight ?? FontWeight.w400,
    letterSpacing: 0.15,
    height: 1.5,
  ...
  static TextStyle bodyMedium({Color? color, FontWeight? fontWeight}) => _safePoppins(
    fontSize: 14,
    fontWeight: fontWeight ?? FontWeight.w400,
    letterSpacing: 0.25,
    height: 1.5,
  ...
  static TextStyle bodySmall({Color? color, FontWeight? fontWeight}) => _safePoppins(
    fontSize: 12,
    fontWeight: fontWeight ?? FontWeight.w400,
    letterSpacing: 0.4,
    height: 1.4,
  ...
  static TextStyle labelLarge({Color? color, FontWeight? fontWeight}) => _safePoppins(
    fontSize: 16,
    fontWeight: fontWeight ?? FontWeight.w500,
    letterSpacing: 0.1,
    height: 1.4,
  ...
  static TextStyle labelMedium({Color? color, FontWeight? fontWeight}) => _safePoppins(
    fontSize: 14,
    fontWeight: fontWeight ?? FontWeight.w500,
    letterSpacing: 0.5,
    height: 1.4,
  ...
  static TextStyle labelSmall({Color? color, FontWeight? fontWeight}) => _safePoppins(
    fontSize: 12,
    fontWeight: fontWeight ?? FontWeight.w500,
    letterSpacing: 0.5,
    height: 1.4,
  ...
  static TextStyle caption({Color? color, FontWeight? fontWeight}) => _safePoppins(
    fontSize: 11,
    fontWeight: fontWeight ?? FontWeight.w400,
    letterSpacing: 0.4,
    height: 1.3,
