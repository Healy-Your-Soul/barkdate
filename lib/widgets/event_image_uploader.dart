      ...
      children: [
        Row(
          children: [
            ...
            Text('(${images.length}/$maxImages)', style: theme.textTheme.bodySmall),
          ],
        ),
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            if (canAddMore && index == images.length) {
              return _AddTile(onPressed: onAddPressed, isUploading: isUploading);
            }
          ...
          child: isUploading
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Text('Add photos', style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.primary)),
                  ],
                ),
        ),
      ),
